...
|-------|-----|------|----------|
| Full | `ghcr.io/pithecene-io/quarry:0.13.2` | amd64 | Quarry CLI, Node.js, Puppeteer, Chrome for Testing, fonts |
| Slim | `ghcr.io/pithecene-io/quarry:0.13.2-slim` | amd64, arm64 | Quarry CLI, Node.js, Puppeteer (no browser) |
...
docker run --rm \
  ...
  -v ./data:/work/data \
  ghcr.io/pithecene-io/quarry:0.13.2 \
  run \
...
services:
  quarry:
    image: ghcr.io/pithecene-io/quarry:0.13.2
    volumes:
...
services:
  ...
  quarry:
    image: ghcr.io/pithecene-io/quarry:0.13.2-slim
    depends_on:
      - chrome
    volumes:
      - ./scripts:/work/scripts:ro
