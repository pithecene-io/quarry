# Release Readiness: v0.3.0 (Temporary)

This document is a temporary checklist for the v0.3.0 release.
Replace or remove once the long-term release process is defined.

**Status**: Draft
**Scope**: v0.3.0 release gating only
